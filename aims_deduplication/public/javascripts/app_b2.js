...
.controller('mainController', function($scope, $http) {
	...
	$scope.viewMatchingOPISRecords = function(wosid) {
		...
		$http.get('/b2/opis_matching_items/' + wosid)
			.success(function(data) {
	...
	$scope.updateManualMatch = function(wosid, publicationid, ismatch) {
		$http.get('/b2/update_manual_match/' + wosid + '/' + publicationid + '/' + ismatch)
			.success(function(data) {
	...
	$scope.listWOSRecords = function(pageRangeLink) {
		$http.get('/b2/list_wos/' + pageRangeLink)
			.success(function(data) {
				$scope.wosData = data;
	...
	$scope.markDeleteOPISRecord = function(publicationid, isdelete) {
		$http.get('/b2/mark_delete/' + publicationid + '/' + isdelete)
			.success(function(data) {
	...
	// Start...
	$http.get('/b2/get_page_count/500')
		.success(function(data) {
