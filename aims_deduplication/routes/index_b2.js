...
var db3file = "\\\\rsdi-ns01.lib.cuhk.edu.hk\\etd\\aims_data_integration\\aims_data_integration_batch2.db3";
...
{
  res.sendFile(path.join(__dirname, '../views', 'index_b2.html'));
});
...
router.get('/opis_matching/gather_results/:limit', function(req, res) {
	var results = {};
	...
	db.serialize(function()
	{
		var stmt = db.prepare(allWOSRecordsSQL + " LIMIT ?");
